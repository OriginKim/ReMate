...
public class WorkspaceController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<Long>> createWorkspace(@RequestParam String name, Principal principal) {
    return ResponseEntity.ok(ApiResponse.ok(workspaceService.createWorkspace(name, principal.getName())));
  }

  @PostMapping("/{workspaceId}/invite")
  public ResponseEntity<ApiResponse<Void>> invite(@PathVariable Long workspaceId, @RequestParam String email, Principal principal) {
    workspaceService.inviteByEmail(workspaceId, email, principal.getName());
    return ResponseEntity.ok(ApiResponse.ok());
  }

  @GetMapping("/invitations")
  public ResponseEntity<ApiResponse<List<WorkspaceResponseDto>>> getInvitations(Principal principal) {
    return ResponseEntity.ok(ApiResponse.ok(workspaceService.getPendingInvitations(principal.getName())));
  }
  ...
  @GetMapping("/my")
  public ResponseEntity<ApiResponse<List<WorkspaceResponseDto>>> getMyWorkspaces(Principal principal) {
